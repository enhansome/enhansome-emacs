...
* Awesome Emacs
  ...
  \[\[<https://github.com/emacs-tw/awesome-emacs/actions/workflows/main.yml][https://github.com/emacs-tw/awesome-emacs/actions/workflows/main.yml/badge.svg> ⭐ 9,362 | 🐛 38 | 📅 2026-05-13]]
...
\*\*\* Windows
Emacs can be downloaded from the \[\[<http://ftp.gnu.org/gnu/emacs/windows/][GNU> FTP]] or a GNU mirror listed on the \[\[<https://www.gnu.org/software/emacs/download.html][GNU> Emacs Download & Installation page]], and/or using the \[\[<https://www.msys2.org][MSYS2>]] pacman manager. Another option is to install emacs via the \[\[<https://community.chocolatey.org/packages/Emacs][Chocolatey>]] or \[\[<https://github.com/ScoopInstaller/Extras/blob/master/bucket/emacs.json][scoop> ⭐ 2,141 | 🐛 808 | 🌐 PowerShell | 📅 2026-08-21]] Windows package managers. A default install of Windows does not contain emacs.
...
* In addition, for an excellent selection of personal .emacs.d configurations, take a look at \[\[<https://github.com/caisah/emacs.dz> ⭐ 1,548 | 🐛 3 | 📅 2026-06-24]].
  \#+END\_QUOTE
