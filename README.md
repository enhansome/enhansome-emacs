...
\*\*\* Windows
Emacs can be downloaded from the \[\[<http://ftp.gnu.org/gnu/emacs/windows/][GNU> FTP]] or a GNU mirror listed on the \[\[<https://www.gnu.org/software/emacs/download.html][GNU> Emacs Download & Installation page]], and/or using the \[\[<https://www.msys2.org][MSYS2>]] pacman manager. Another option is to install emacs via the \[\[<https://community.chocolatey.org/packages/Emacs][Chocolatey>]] or \[\[<https://github.com/ScoopInstaller/Extras/blob/master/bucket/emacs.json][scoop> ⭐ 2,150 | 🐛 813 | 🌐 PowerShell | 📅 2026-09-10]] Windows package managers. A default install of Windows does not contain emacs.
...
* \[\[<https://github.com/serras/emacs-haskell-tutorial/blob/master/tutorial.md][Using> ⭐ 686 | 🐛 6 | 🌐 Emacs Lisp | 📅 2017-03-14 Emacs for Haskell development]]
  \#+END\_QUOTE
...
* In addition, for an excellent selection of personal .emacs.d configurations, take a look at \[\[<https://github.com/caisah/emacs.dz> ⭐ 1,550 | 🐛 3 | 📅 2026-09-08]].
  \#+END\_QUOTE
